    ...
    return (
          <div className="col-md-4 col-sm-12 py-2 justify-content-center">
            <div className="card card-body flex-column text-center p-3 mb-2 bg-secondary text-white h-100">
                ...
                <Button variant="secondary" size="lg" href='https://kadowning1.github.io/mindreader/' target='_blank'>
                    Demo App </Button>
                <Button variant="secondary" size="lg" href='https://github.com/kadowning1/mindreader' target='_blank'>
                    Github Repo </Button>
            </div>
        </div>
    )
