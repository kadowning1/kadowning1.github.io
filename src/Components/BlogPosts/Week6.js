                ...
                <div className="clearfix">
                    <div className="card position-relative top-50 start-50 translate-middle bg-secondary p-3">
                        ...
                        <div className="card-body text-white">
                            <h5 className="card-title text-white">Week 2 Front-End</h5>
                            <p className="card-text">Week 2 of Front-end of the Bootcamp is in the books. Our cohort had an up and down week with learning through the
                        ...
                        <div className="card-footer">
                            <small className="text-center">Week of September 27 to October 3, 2021</small>
                        </div>
                    </div>
                </div>
            </div>
