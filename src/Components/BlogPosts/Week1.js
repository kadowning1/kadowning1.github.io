                    ...
                    <div class="card position-relative top-50 start-50 translate-middle bg-secondary p-3">
                        <img src="/img/Markdown.png"
                            ...
                            <div class="card-body text-white">
                             ...
                             Prework) to be in a position to approach the camp full steam ahead.</p>

                                <p>The first week has given me all the emotions that I've expected. Excitement, nervousness,
